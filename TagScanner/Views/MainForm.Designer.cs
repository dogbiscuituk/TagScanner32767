namespace TagScanner.Views
{
	partial class MainForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.pictureCountDataGridViewTextBoxColumn = new System.Windows.Forms.DataGridViewTextBoxColumn();
			this.possiblyCorruptDataGridViewCheckBoxColumn = new System.Windows.Forms.DataGridViewCheckBoxColumn();
            ...
            this.pictureCountDataGridViewTextBoxColumn,
            this.possiblyCorruptDataGridViewCheckBoxColumn,
			...
			this.albumDataGridViewTextBoxColumn.FillWeight = 101.862F;
			...
			this.albumSortDataGridViewTextBoxColumn.ReadOnly = true;
			this.albumSortDataGridViewTextBoxColumn.Visible = false;
			// 
			...
			this.amazonIdDataGridViewTextBoxColumn.ReadOnly = true;
			this.amazonIdDataGridViewTextBoxColumn.Visible = false;
			// 
			...
			this.audioBitrateDataGridViewTextBoxColumn.ReadOnly = true;
			this.audioBitrateDataGridViewTextBoxColumn.Visible = false;
			// 
			...
			this.audioChannelsDataGridViewTextBoxColumn.ReadOnly = true;
			this.audioChannelsDataGridViewTextBoxColumn.Visible = false;
			// 
			...
			this.audioSampleRateDataGridViewTextBoxColumn.ReadOnly = true;
			this.audioSampleRateDataGridViewTextBoxColumn.Visible = false;
			// 
			...
			this.beatsPerMinuteDataGridViewTextBoxColumn.ReadOnly = true;
			this.beatsPerMinuteDataGridViewTextBoxColumn.Visible = false;
			// 
			...
			this.bitsPerSampleDataGridViewTextBoxColumn.ReadOnly = true;
			this.bitsPerSampleDataGridViewTextBoxColumn.Visible = false;
			// 
			...
			this.centuryDataGridViewTextBoxColumn.Visible = false;
			// 
			...
			this.codecsDataGridViewTextBoxColumn.ReadOnly = true;
			this.codecsDataGridViewTextBoxColumn.Visible = false;
			// 
			...
			this.copyrightDataGridViewTextBoxColumn.Visible = false;
			// 
			...
			this.decadeDataGridViewTextBoxColumn.Visible = false;
			// 
			...
			this.discDataGridViewTextBoxColumn.Visible = false;
			// 
			...
			this.discCountDataGridViewTextBoxColumn.ReadOnly = true;
			this.discCountDataGridViewTextBoxColumn.Visible = false;
			// 
			...
			this.discOfDataGridViewTextBoxColumn.Visible = false;
			// 
			// durationDataGridViewTextBoxColumn
			// 
			this.durationDataGridViewTextBoxColumn.DataPropertyName = "Duration";
			dataGridViewCellStyle6.Alignment = System.Windows.Forms.DataGridViewContentAlignment.MiddleRight;
			this.durationDataGridViewTextBoxColumn.DefaultCellStyle = dataGridViewCellStyle6;
			this.durationDataGridViewTextBoxColumn.FillWeight = 98.17667F;
			...
			this.fileAttributesDataGridViewTextBoxColumn.ReadOnly = true;
			this.fileAttributesDataGridViewTextBoxColumn.Visible = false;
			// 
			...
			this.fileCreationTimeDataGridViewTextBoxColumn.ReadOnly = true;
			this.fileCreationTimeDataGridViewTextBoxColumn.Visible = false;
			// 
			...
			this.fileCreationTimeUtcDataGridViewTextBoxColumn.ReadOnly = true;
			this.fileCreationTimeUtcDataGridViewTextBoxColumn.Visible = false;
			// 
			// FileExtension
			// 
			...
			this.fileLastAccessTimeDataGridViewTextBoxColumn.ReadOnly = true;
			this.fileLastAccessTimeDataGridViewTextBoxColumn.Visible = false;
			// 
			...
			this.fileLastAccessTimeUtcDataGridViewTextBoxColumn.ReadOnly = true;
			this.fileLastAccessTimeUtcDataGridViewTextBoxColumn.Visible = false;
			// 
			...
			this.fileLastWriteTimeDataGridViewTextBoxColumn.ReadOnly = true;
			this.fileLastWriteTimeDataGridViewTextBoxColumn.Visible = false;
			// 
			...
			this.fileLastWriteTimeUtcDataGridViewTextBoxColumn.ReadOnly = true;
			this.fileLastWriteTimeUtcDataGridViewTextBoxColumn.Visible = false;
			// 
			// fileSizeDataGridViewTextBoxColumn
			// 
			this.fileSizeDataGridViewTextBoxColumn.DataPropertyName = "FileSize";
			dataGridViewCellStyle7.Alignment = System.Windows.Forms.DataGridViewContentAlignment.MiddleRight;
			this.fileSizeDataGridViewTextBoxColumn.DefaultCellStyle = dataGridViewCellStyle7;
			this.fileSizeDataGridViewTextBoxColumn.FillWeight = 97.46193F;
			...
			this.firstAlbumArtistDataGridViewTextBoxColumn.ReadOnly = true;
			this.firstAlbumArtistDataGridViewTextBoxColumn.Visible = false;
			// 
			...
			this.firstAlbumArtistSortDataGridViewTextBoxColumn.ReadOnly = true;
			this.firstAlbumArtistSortDataGridViewTextBoxColumn.Visible = false;
			// 
			...
			this.firstComposerDataGridViewTextBoxColumn.ReadOnly = true;
			this.firstComposerDataGridViewTextBoxColumn.Visible = false;
			// 
			...
			this.firstComposerSortDataGridViewTextBoxColumn.ReadOnly = true;
			this.firstComposerSortDataGridViewTextBoxColumn.Visible = false;
			// 
			...
			this.firstGenreDataGridViewTextBoxColumn.ReadOnly = true;
			this.firstGenreDataGridViewTextBoxColumn.Visible = false;
			// 
			...
			this.firstPerformerSortDataGridViewTextBoxColumn.ReadOnly = true;
			this.firstPerformerSortDataGridViewTextBoxColumn.Visible = false;
			// 
			...
			this.groupingDataGridViewTextBoxColumn.Visible = false;
			// 
			...
			this.invariantEndPositionDataGridViewTextBoxColumn.ReadOnly = true;
			this.invariantEndPositionDataGridViewTextBoxColumn.Visible = false;
			// 
			...
			this.invariantStartPositionDataGridViewTextBoxColumn.ReadOnly = true;
			this.invariantStartPositionDataGridViewTextBoxColumn.Visible = false;
			// 
			...
			this.joinedAlbumArtistsDataGridViewTextBoxColumn.ReadOnly = true;
			this.joinedAlbumArtistsDataGridViewTextBoxColumn.Visible = false;
			// 
			...
			this.joinedComposersDataGridViewTextBoxColumn.ReadOnly = true;
			this.joinedComposersDataGridViewTextBoxColumn.Visible = false;
			// 
			...
			this.joinedGenresDataGridViewTextBoxColumn.ReadOnly = true;
			this.joinedGenresDataGridViewTextBoxColumn.Visible = false;
			// 
			...
			this.joinedPerformersDataGridViewTextBoxColumn.FillWeight = 101.862F;
			this.joinedPerformersDataGridViewTextBoxColumn.HeaderText = "Artist";
			...
			this.joinedPerformersSortDataGridViewTextBoxColumn.ReadOnly = true;
			this.joinedPerformersSortDataGridViewTextBoxColumn.Visible = false;
			// 
			...
			this.lyricsDataGridViewTextBoxColumn.Visible = false;
			// 
			...
			this.mediaTypesDataGridViewTextBoxColumn.ReadOnly = true;
			this.mediaTypesDataGridViewTextBoxColumn.Visible = false;
			// 
			...
			this.millenniumDataGridViewTextBoxColumn.Visible = false;
			// 
			...
			this.mimeTypeDataGridViewTextBoxColumn.Visible = false;
			// 
			...
			this.musicBrainzArtistIdDataGridViewTextBoxColumn.ReadOnly = true;
			this.musicBrainzArtistIdDataGridViewTextBoxColumn.Visible = false;
			// 
			...
			this.musicBrainzDiscIdDataGridViewTextBoxColumn.ReadOnly = true;
			this.musicBrainzDiscIdDataGridViewTextBoxColumn.Visible = false;
			// 
			...
			this.musicBrainzReleaseArtistIdDataGridViewTextBoxColumn.ReadOnly = true;
			this.musicBrainzReleaseArtistIdDataGridViewTextBoxColumn.Visible = false;
			// 
			...
			this.musicBrainzReleaseCountryDataGridViewTextBoxColumn.ReadOnly = true;
			this.musicBrainzReleaseCountryDataGridViewTextBoxColumn.Visible = false;
			// 
			...
			this.musicBrainzReleaseIdDataGridViewTextBoxColumn.ReadOnly = true;
			this.musicBrainzReleaseIdDataGridViewTextBoxColumn.Visible = false;
			// 
			...
			this.musicBrainzReleaseStatusDataGridViewTextBoxColumn.ReadOnly = true;
			this.musicBrainzReleaseStatusDataGridViewTextBoxColumn.Visible = false;
			// 
			...
			this.musicBrainzReleaseTypeDataGridViewTextBoxColumn.ReadOnly = true;
			this.musicBrainzReleaseTypeDataGridViewTextBoxColumn.Visible = false;
			// 
			...
			this.musicBrainzTrackIdDataGridViewTextBoxColumn.ReadOnly = true;
			this.musicBrainzTrackIdDataGridViewTextBoxColumn.Visible = false;
			// 
			...
			this.musicIpIdDataGridViewTextBoxColumn.ReadOnly = true;
			this.musicIpIdDataGridViewTextBoxColumn.Visible = false;
			// 
			...
			this.photoHeightDataGridViewTextBoxColumn.ReadOnly = true;
			this.photoHeightDataGridViewTextBoxColumn.Visible = false;
			// 
			...
			this.photoQualityDataGridViewTextBoxColumn.ReadOnly = true;
			this.photoQualityDataGridViewTextBoxColumn.Visible = false;
			// 
			...
			this.photoWidthDataGridViewTextBoxColumn.ReadOnly = true;
			this.photoWidthDataGridViewTextBoxColumn.Visible = false;
			// 
			// pictureCountDataGridViewTextBoxColumn
			// 
			this.pictureCountDataGridViewTextBoxColumn.DataPropertyName = "PictureCount";
			this.pictureCountDataGridViewTextBoxColumn.HeaderText = "PictureCount";
			this.pictureCountDataGridViewTextBoxColumn.Name = "pictureCountDataGridViewTextBoxColumn";
			this.pictureCountDataGridViewTextBoxColumn.ReadOnly = true;
			this.pictureCountDataGridViewTextBoxColumn.Visible = false;
			// 
			// possiblyCorruptDataGridViewCheckBoxColumn
			// 
			this.possiblyCorruptDataGridViewCheckBoxColumn.DataPropertyName = "PossiblyCorrupt";
			this.possiblyCorruptDataGridViewCheckBoxColumn.HeaderText = "PossiblyCorrupt";
			this.possiblyCorruptDataGridViewCheckBoxColumn.Name = "possiblyCorruptDataGridViewCheckBoxColumn";
			this.possiblyCorruptDataGridViewCheckBoxColumn.ReadOnly = true;
			this.possiblyCorruptDataGridViewCheckBoxColumn.Visible = false;
			// 
			...
			this.tagTypesDataGridViewTextBoxColumn.ReadOnly = true;
			this.tagTypesDataGridViewTextBoxColumn.Visible = false;
			// 
			...
			this.tagTypesOnDiskDataGridViewTextBoxColumn.ReadOnly = true;
			this.tagTypesOnDiskDataGridViewTextBoxColumn.Visible = false;
			// 
			// titleDataGridViewTextBoxColumn
			// 
			this.titleDataGridViewTextBoxColumn.DataPropertyName = "Title";
			this.titleDataGridViewTextBoxColumn.FillWeight = 101.862F;
			...
			this.titleSortDataGridViewTextBoxColumn.ReadOnly = true;
			this.titleSortDataGridViewTextBoxColumn.Visible = false;
			// 
			...
			this.trackDataGridViewTextBoxColumn.Visible = false;
			// 
			...
			this.trackCountDataGridViewTextBoxColumn.ReadOnly = true;
			this.trackCountDataGridViewTextBoxColumn.Visible = false;
			// 
			...
			this.trackOfDataGridViewTextBoxColumn.Visible = false;
			// 
			...
			this.videoHeightDataGridViewTextBoxColumn.ReadOnly = true;
			this.videoHeightDataGridViewTextBoxColumn.Visible = false;
			// 
			...
			this.videoWidthDataGridViewTextBoxColumn.ReadOnly = true;
			this.videoWidthDataGridViewTextBoxColumn.Visible = false;
			// 
			// yearDataGridViewTextBoxColumn
			// 
			this.yearDataGridViewTextBoxColumn.DataPropertyName = "Year";
			dataGridViewCellStyle8.Alignment = System.Windows.Forms.DataGridViewContentAlignment.MiddleRight;
			this.yearDataGridViewTextBoxColumn.DefaultCellStyle = dataGridViewCellStyle8;
			this.yearDataGridViewTextBoxColumn.FillWeight = 98.7753F;
			...
			// 
			this.tagFileBindingSource.DataSource = typeof(TagScanner.Model.TagFile);
			// 
			// splitContainer2
			// 
        ...
        private System.Windows.Forms.DataGridViewTextBoxColumn pictureCountDataGridViewTextBoxColumn;
        private System.Windows.Forms.DataGridViewCheckBoxColumn possiblyCorruptDataGridViewCheckBoxColumn;
