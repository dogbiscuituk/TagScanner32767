...
namespace TagScanner
{
    ...
    public class Selection : ITrack
    {
        ...
        private int _bitsPerSample = int.MinValue;
        [Category("Format")]
        [DefaultValue(0)]
		...
		protected virtual string AggregateStrings(Func<ITrack, string> getString)
        {
            return AggregateStringsBlank(getString);
        }

        protected string AggregateStringsBlank(Func<ITrack, string> getString)
        {
        ...
        protected string AggregateStringsCount(Func<ITrack, string> getString)
        {
        ...
        protected virtual uint AggregateUints(Func<ITrack, uint> getUint)
        {
            return AggregateUintsBlank(getUint);
        }

        protected uint AggregateUintsBlank(Func<ITrack, uint> getUint)
        {
        ...
        protected uint? AggregateUintsCount(Func<ITrack, uint?> getUint)
        {
